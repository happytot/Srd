    ...
    <aside className="sidebar">
      ...
      <div className="border-t border-zinc-100 pt-4 mt-4 flex items-center gap-3">
        ...
        <div className="overflow-hidden flex-1">
          ...
          <span className={isAdminRole(user.role) ? 'badge-admin' : 'text-[10px] font-bold uppercase tracking-wider text-violet-700 bg-violet-50 px-2 py-0.5 rounded-full'}>{user.role}</span>
        </div>
        <button
